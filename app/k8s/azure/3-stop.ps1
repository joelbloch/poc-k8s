...
kubectl delete -f ./yaml/db-azure.yaml -f ./yaml/central-session-manager.yaml -f ./yaml/app-server-stateful.yaml -f ./yaml/app-server-stateless.yaml -f ./yaml/web-server.yaml
